  ...
  return (
    <div className=' h-screen w-full flex-1 flex'>
        ...
        <div className="flex flex-col items-center justify-center" >
          <h2 className="text-3xl text-center font-bold mb-2">Hello, friend!</h2>
          <div className=" border-2 w-10 inline-block border-white mb-2 "></div>
          <p className="mb-2">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cumque, quos.</p>
